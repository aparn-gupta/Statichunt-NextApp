...
function PrevArrow(props: ArrowProps) {
 ...
 var settings = {
  ...
  return (
   ...
   <div className="">
     <div className="flex justify-center w-screen bg-lightgrey lg:pt-24  pt-20 md:pt-28 ">
    <div className="lg:w-2/5 w-4/5">
      ...
      <p className="my-8  text-grey lg:text-lg text-xl text-center leading-relaxed "> We are dedicated to delivering exceptional services to our customers and providing top-notch training for our employees.  </p>
    </div>
  </div>
    ...
    <div className="lg:px-32 px-10  md:px-32   lg:pt-8 pb-48   bg-lightgrey">
